...
// GET /api/kurir/available — PAID orders that have not been assigned to any kurir yet
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error("[GET /api/kurir/available]", e);
    return err("Gagal mengambil pesanan tersedia", 500);
  }
}
