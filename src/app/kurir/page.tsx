    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-primary text-white">
        <div className="max-w-xl mx-auto px-4 pt-8 pb-16">
          ...
          <p className="text-primary-foreground/60 text-sm mt-1">Monitor & kelola pengiriman Anda</p>
        </div>
      </div>
        ...
        {loading ? <div className="pt-16"><PageLoader /></div> : (
          <>
            <div className="grid grid-cols-2 gap-4 mb-5">
              {[
                { label: "Total Pengiriman", value: stats.orders, icon: <Package className="h-5 w-5" />, color: "bg-primary/10 text-primary" },
                { label: "Pendapatan", value: formatRupiah(stats.earnings), icon: <TrendingUp className="h-5 w-5" />, color: "bg-primary/10 text-primary" },
              ].map((s) => (
            ...
            <Link href="/kurir/orders"
              className="group flex items-center gap-4 card p-4 hover:-translate-y-0.5 hover:shadow-md transition-all duration-150 mb-3">
            ...
            <Link href="/kurir/payout"
              className="group flex items-center gap-4 card p-4 hover:-translate-y-0.5 hover:shadow-md transition-all duration-150 mb-5">
              <div className="w-11 h-11 bg-primary/10 text-primary rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            {recentOrders.length > 0 && (
              <div className="card overflow-hidden">
                <div className="flex items-center justify-between px-5 pt-4 pb-3 border-b border-gray-50">
                  ...
                  <Link href="/kurir/orders" className="text-xs text-primary hover:text-primary/80 font-semibold flex items-center gap-1">
