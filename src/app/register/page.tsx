    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
        <div className="text-center max-w-sm">
          ...
          <h1 className="text-2xl font-black text-slate-800 mb-3 tracking-tight">Akun Dibuat!</h1>
          <p className="text-slate-600 mb-2">Pendaftaran berhasil. Akun Anda sudah langsung aktif.</p>
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-sm shadow-slate-200 border border-slate-100 p-6">
          ...
          <p className="mt-4 text-xs text-slate-400 text-center">
            {form.role === "BUYER"
              ? "Akun Pembeli langsung aktif setelah pendaftaran."
              : `Akun ${form.role === "KURIR" ? "Kurir" : "Seller"} menunggu persetujuan Admin.`}
          </p>

          {/* Divider */}
          <div className="flex items-center gap-3 my-4">
            <div className="flex-1 h-px bg-slate-100" />
            <span className="text-xs text-slate-400 font-medium">atau daftar dengan</span>
            <div className="flex-1 h-px bg-slate-100" />
          </div>
